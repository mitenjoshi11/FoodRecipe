...
import com.test.foodapp.data.Repository
...
class MainViewModel @Inject constructor(
    ...
    fun getSearchRecipe(searchQuery: Map<String, String>) = viewModelScope.launch {
    ...
    private suspend fun getSearchRecipeSafeCall(searchQuery: Map<String, String>) {
        ...
        if (hasInternetConnection()) {
            try {
                ...
                searchRecipeResponse.value = handleRecipesResponse(response)
